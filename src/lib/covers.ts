...
export interface CoverItem {
  ...
  image: string; // Path to the cover image file
  style: string; // CSS background fallback (gradient)
  patternSvg: string; // SVG pattern overlay for fallback
}
...
export const covers: CoverItem[] = [
  // ===== LUXURY (3) =====
  {
    ...
    name: 'ليلة ذهبية',
    category: 'luxury',
    image: '/images/covers/luxury-gold-night.png',
  ...
  },
  {
    ...
    name: 'مخمل ملكي',
    category: 'luxury',
    image: '/images/covers/luxury-royal-velvet.png',
  ...
  },
  {
    ...
    name: 'دمشق ذهبي',
    category: 'luxury',
    image: '/images/covers/luxury-gold-damascus.png',
  ...
  // ===== FLORAL (3) =====
  {
    ...
    name: 'حديقة الورود',
    category: 'floral',
    image: '/images/covers/floral-rose-garden.png',
  ...
  },
  {
    ...
    name: 'تفتح وردي',
    category: 'floral',
    image: '/images/covers/floral-blush-bloom.png',
  ...
  },
  {
    ...
    name: 'رقصة البتلات',
    category: 'floral',
    image: '/images/covers/floral-petals-dance.png',
  ...
  // ===== MINIMAL (3) =====
  {
    ...
    name: 'ضباب فضي',
    category: 'minimal',
    image: '/images/covers/minimal-silver-mist.png',
  ...
  },
  {
    ...
    name: 'لؤلؤة ناعمة',
    category: 'minimal',
    image: '/images/covers/minimal-soft-pearl.png',
  ...
  },
  {
    ...
    name: 'فحم هادئ',
    category: 'minimal',
    image: '/images/covers/minimal-charcoal.png',
  ...
  // ===== MODERN (3) =====
  {
    ...
    category: 'modern',
    image: '/images/covers/modern-midnight-geometric.png',
    style: 'linear-gradient(135deg, #0A0A0A 0%, #1A1A2E 30%, #16213E 60%, #0A0A0A 100%)',
    patternSvg: `<svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%"><defs><pattern id="p-mod1" x="0" y="0" width="60" height="60" patternUnits="userSpaceOnUse"><path d="M0 0 L30 0 L30 30 L0 30Z" fill="none" stroke="#C0C0C0" stroke-width="0.3" opacity="0.08"/><path d="M30 30 L60 30 L60 60 L30 60Z" fill="none" stroke="#C0C0C0" stroke-width="0.3" opacity="0.06"/></pattern></defs><rect width="100%" height="100%" fill="url(#p-mod1)"/></svg>`,
  },
  {
    id: 'modern-silver-steel',
    name: 'فضة صلب',
    category: 'modern',
    image: '/images/covers/modern-silver-steel.png',
  ...
  },
  {
    ...
    name: 'نيون فاخر',
    category: 'modern',
    image: '/images/covers/modern-neon-luxe.png',
    style: 'linear-gradient(135deg, #0D0D1A 0%, #1A1A2E 40%, #0F2027 70%, #0D0D1A 100%)',
    patternSvg: `<svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%"><defs><pattern id="p-mod3" x="0" y="0" width="100" height="100" patternUnits="userSpaceOnUse"><path d="M0 50 L50 0" stroke="#C0C0C0" stroke-width="0.3" opacity="0.06"/><path d="M50 0 L100 50" stroke="#C0C0C0" stroke-width="0.3" opacity="0.06"/><path d="M0 50 L50 100" stroke="#C0C0C0" stroke-width="0.3" opacity="0.06"/><path d="M50 100 L100 50" stroke="#C0C0C0" stroke-width="0.3" opacity="0.06"/><circle cx="50" cy="50" r="8" fill="none" stroke="#FFFFFF" stroke-width="0.4" opacity="0.06"/></pattern></defs><rect width="100%" height="100%" fill="url(#p-mod3)"/></svg>`,
  },
];

// Default couple photo options
export interface CouplePhotoOption {
  id: string;
  name: string;
  image: string;
}

export const couplePhotos: CouplePhotoOption[] = [
  { id: 'couple-golden', name: 'ذهبي كلاسيكي', image: '/images/couples/couple-golden.png' },
  { id: 'couple-crescent', name: 'هلال إسلامي', image: '/images/couples/couple-crescent.png' },
  { id: 'couple-floral', name: 'وردي رومانسي', image: '/images/couples/couple-floral.png' },
  { id: 'couple-minimal', name: 'بسيط أنيق', image: '/images/couples/couple-minimal.png' },
  { id: 'couple-modern', name: 'عصري هندسي', image: '/images/couples/couple-modern.png' },
];
